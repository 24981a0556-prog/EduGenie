...
import { getSubjects, predictQuestions } from '@/lib/api';
      ...
      <div className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Unit-wise predicted exam questions</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
          {subjects.map(s => (
            <Button
              ...
              size="sm"
              onClick={() => { setActiveSubjectId(s.id); setSelectedUnitId(null); setPredictions([]); }}
            >
              {s.name}
            </Button>
          ))}
        ...
        <div className="grid md:grid-cols-[280px_1fr] gap-6">
          ...
          <div>
            ...
            {selectedUnitId && !loading && predictions.length > 0 && (
